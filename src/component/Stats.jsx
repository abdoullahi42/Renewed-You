...
function Stats() {
  return (
    <section className=" lg:mb-14 bg-white pt-5">
      <h2 className="font-semibold font-abdu text-3xl md:text-3xl lg:text-5xl mb-7 text-center md:mb-11 lg:mb-16  px-2">
      ...
      <div className="flex flex-col text-center mx-3 mb-8  min-[960px]:flex-row  min-[960px]:gap-16 min-[960px]:px-4 lg:mb-20">
        <div className="min-[960px]:flex-1 min-[960px]:self-center">
          <p className="text-2xl font-semibold mb-5 tracking-tight md:mb-8 lg:text-5xl  lg:tracking-normal lg:font-medium lg:leading-snug">
