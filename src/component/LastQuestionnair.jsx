...
function LastQuestionnair() {
  ...
  return (
    <section className="w-10/12 mx-auto my-8">
      <div className="h-fit py-4 w-3/5 mx-auto rounded-lg">
        {currentStep === 0 && (
          <div className="p-8 w-10/12 mx-auto mb-8 rounded-lg" style={{ boxShadow: "-2px -2px 4px 0px #00000040" }}>
        ...
        {currentStep === 1 && (
          <div>
            ...
            <div className="w-3/4 mx-auto p-8 mb-8 px-10 rounded-lg" style={{ boxShadow: "-2px -2px 4px 0px #00000040" }}>
        ...
        {(currentStep === 2 || currentStep === 3) && (
          <div className="w-10/12 mx-auto">
            <div>
              ...
              <div className="w-11/12 mx-auto py-5 mb-8 rounded-lg" style={{ boxShadow: "-2px -2px 4px 0px #00000040" }}>
                {dataCheckBox[currentStep - 2].checkBoxOptions.map((option, i) => (
                  <div className="flex items-center gap-3 mb-2 px-4 w-3/4 mx-auto" key={i}>
                    <input type="checkbox" />
            ...
            <div className="w-11/12 mx-auto py-5 mb-8 rounded-lg" style={{ boxShadow: "-2px -2px 4px 0px #00000040" }}>
              <div className="px-11 pb-11">
                <input
                  ...
                  className="border h-[252px] border-[#8A8888] outline-none w-10/12 mx-auto rounded-lg pt-0 px-4"
                />
              </div>
              <div className="flex text-right border border-red-500 justify-end">
                <button className="bg-[#4BDBA7] text-white py-2 px-4 text-right rounded-[50px]" onClick={handleNext}>
