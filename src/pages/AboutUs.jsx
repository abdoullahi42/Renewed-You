      ...
      <section className="my-14">
        <div className="text-center mb-5 lg:mb-7">
          ...
          <div className=" mb-3  flex flex-col p-5 lg:items-center lg:mb-12 ">
            ...
            <p className=" text-center  lg:mx-auto lg:w-[77%] lg:text-[17px] lg:px-5">
          ...
          <div className="text-center mx-auto flex flex-col items-center justify-center lg:mb-14">
            <div className="mx-5 lg:mb-12">
              <h3 className="text-xl lg:text-3xl mb-5">Our therapists</h3>
            </div>
            <div className="text-center px-9 mx-7 grid grid-cols-3 sm:grid-cols-4 gap-6 min-[929px]:grid-cols-5 min-[929px]:gap-8">
